...
class ViolationPolicy
{
    ...
    {
        return $user->can('delete_any_violation');
    }
    ...
    {
        return $user->can('force_delete_any_violation');
    }
    ...
    {
        return $user->can('restore_any_violation');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Violation $violation): bool
    {
        return $user->can('replicate_violation');
    }
    ...
    {
        return $user->can('reorder_violation');
    }
}
