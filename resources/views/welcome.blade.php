...
<body class="bg-gray-100 font-sans">
  ...
  <!-- Hero Section -->
  <section class="bg-slate-600 text-white py-20">
    ...
    <div class="container mx-auto px-6 text-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-gray-50 p-6 rounded-lg shadow-md">
          <h3 class="text-xl font-semibold text-slate-600 mb-4">Pelaporan Cepat</h3>
          <p class="text-gray-600">Laporkan pelanggaran siswa dengan cepat dan mudah melalui aplikasi ini.</p>
        </div>
        <div class="bg-gray-50 p-6 rounded-lg shadow-md">
          <h3 class="text-xl font-semibold text-slate-600 mb-4">Analisis Data</h3>
          <p class="text-gray-600">Dapatkan analisis lengkap tentang pelanggaran siswa dalam bentuk grafik dan tabel.</p>
        </div>
        <div class="bg-gray-50 p-6 rounded-lg shadow-md">
          <h3 class="text-xl font-semibold text-slate-600 mb-4">Notifikasi Otomatis</h3>
  ...
  <section class="bg-slate-600 text-white py-16">
    <div class="container mx-auto px-6 text-center">
      ...
      <a href="#" class="bg-slate-700 hover:bg-slate-800 text-white font-semibold py-3 px-6 rounded-full transition duration-300">
        Daftar Sekarang
      </a>
    </div>
  </section>
